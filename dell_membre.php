...
<html lang="fr">
	...
	<?php  require "template/header.php"; ?>
		<?php 
			...
			echo " <h1 style='color:green'>L'utilisateur ayant pour ID : " . $idMembre . " à bien été supprimé </h1><br><p class='my-4 h3' style='color:red'> Vous allez être redirigé dans 5 secondes</p>";

			header("refresh:4;URL=gestion_membres.php");
	?>
