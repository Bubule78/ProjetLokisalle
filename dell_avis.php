...
<html lang="fr">
	<head>
		<title>Admin suppression des membres</title>
		<meta charset="UTF-8">
		<!-- Bootstrap -->
	...
	<?php  require "template/header.php"; ?>
		<?php 
			...
			echo " <h1 style='color:green'>L'avis ayant pour ID : " . $idAvis . " à bien été supprimé </h1><br><p class='my-4 h3' style='color:red'> Vous allez être redirigé dans 5 secondes</p>";

	// A placer dans la page DELL_avis pour rendre le bouton Suppr opé
